export default function Links(){
    return(
        <div className="links-wrapper">
            <a href="https://twitter.com/hnginternship" className="link-button">Twitter Link</a>
            <a href="https://training.zuri.team/" id="btn__zuri" className="link-button">Zuri Team</a>
            <a href="http://books.zuri.team/" id="books" className="link-button">Zuri Books</a> 
